...
from .views import scrape_specific, scrape_multilevel_view, scrape_google_keyword, scrape_yellow_pages_view, scraper, professional_scraper, save_result_view, delete_scraped_result

app_name= "scraper"
urlpatterns = [
    path("scraper/", scraper, name="scraper"),
    path("professional/", professional_scraper, name="professional_scraper"),
